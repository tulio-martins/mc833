    ...
    * e termina*/
    ...
    /*Menu de execucao geral do cliente*/
      do {
          ...
          t_conexao = fopen("CONEXAO_CLIENTE.csv", "a");
          ...
          switch (option) {
            case LIST_DISCIPLINES:
                tempos = fopen("CLIENT_LIST_DISCIPLINES.csv", "a");
                gettimeofday(&t1, NULL);
            ...
            case DISCIPLINE_TABLE:
                ...
                tempos = fopen("CLIENT_DISCIPLINE_TABLE.csv", "a");
                gettimeofday(&t1, NULL);
            ...
            case DISCIPLINE_INFO:
                ...
                tempos = fopen("CLIENT_DICSIPLINE_INFO.csv", "a");
                gettimeofday(&t1, NULL);
            ...
            case ALL_DISCIPL_INFO:
                ...
                tempos = fopen("CLIENT_ALL_DISCIPL_INFO.csv", "a");
                gettimeofday(&t1, NULL);
                for(int i = 0; i < 10; i++) {
                  if(recvDisciplineInfo(socket_fd)){
                    option = CONNECTION_CLOSED;
            ...
            case WRITE_COMMENT:
               ...
               tempos = fopen("CLIENT_WRITE_COMMENT.csv", "a");
               gettimeofday(&t1, NULL);
            ...
            case NEXT_CLASS_COMM:
              ...
              tempos = fopen("CLIENT__NEXT_CLASS_COMM.csv", "a");
              gettimeofday(&t1, NULL);
